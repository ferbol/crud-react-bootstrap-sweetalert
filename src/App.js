    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        Axios.delete(`http://localhost:3001/delete/${val.id}`).then(()=>{
          ...
          Swal.fire({              
              icon: 'success',
              title: "<i>El empleado <strong>"+val.nombre+"</strong> fue eliminado.</i>",
      ...
      <div className="card text-center">
        ...
        <div className="card-body">
          ...
          <div className="input-group mb-3">
            ...
            className="form-control" value={pais} placeholder="Pais" aria-label="Username" aria-describedby="basic-addon1"/>
          </div>
          ...
          <div className="input-group mb-3">
            ...
            className="form-control" value={anios} placeholder="Años de experiencia" aria-label="Username" aria-describedby="basic-addon1"/>
          </div>
        ...
        <div className="card-footer text-body-secondary">
          {
            ...
            <div>
              ...
              <button className='btn btn-info m-2' onClick={limpiarCampos}>Carcelar</button>
            </div>
            :
